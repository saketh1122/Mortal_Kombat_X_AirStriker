...
def parse_cmdline(argv):
    ...
    # parser.add_argument('--display_width', type=int, default='720')
    # parser.add_argument('--display_height', type=int, default='440')
...
class ModelTrainer:
    ...
    def train(self):
        ...
        checkpoint_callback = CheckpointCallback(
            save_freq=self.args.save_freq // self.args.num_env,  
            save_path=self.output_fullpath,
            # name_prefix='model_checkpoint' + self.args.state,
            # save_replay_buffer=True, # newly added
            save_vecnormalize=True # newly added
        )
